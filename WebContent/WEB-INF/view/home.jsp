...
<link
	...
	rel="stylesheet">
<link href='<c:url value="/resources/vendor/fontawesome-free/css/all.min.css" ></c:url>'
	rel="stylesheet">
...
<body id="page-top">
	...
	<div class="container-fluid p-0">
		...
		<section class="resume-section p-3 p-lg-5 d-flex align-items-center"
			...
			<div class="w-100">
				<h1 class="mb-0">
					<c:out value="${user.nama_lengkap }"></c:out> </span>
				</h1>
				<div class="subheading mb-5">
					<c:out value="${user.telp }"></c:out> · <a
						href='mailto:<c:out value="${user.email }"></c:out>'><c:out value="${user.email }"></c:out> </a>
				</div>

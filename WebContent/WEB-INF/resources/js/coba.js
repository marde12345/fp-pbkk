...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
  ...
  // Menu items
 	$scope.menu = [
    {
      ...
      icon: 'action:ic_perm_contact_calendar_24px' // we have to use Google's naming convention for the IDs of the SVGs in the spritesheet
    },
    {
      link : '',
      title: 'Files',
      icon: 'file:ic_folder_24px'
    },
    {
      link : '',
      title: 'Tasks',
      icon: 'av:ic_playlist_add_check_24px'
    },
    {
      link : '',
      title: 'Questions & Answers',
      icon: 'communication:ic_forum_24px'
    }
  ];
  $scope.admin = [
    {
